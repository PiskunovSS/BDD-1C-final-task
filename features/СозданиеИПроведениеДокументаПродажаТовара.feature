...
Сценарий: проведения нового документа "Продажа товара" с ошибкой при нехватке товара
	Допустим я создаю новый документ
		И Я нажимаю кнопку командного интерфейса "Продажа товара"
		Тогда открылось окно "Продажа товара"
		И     я нажимаю на кнопку "Создать"
	...
	Когда я заполняю табличную часть
		...
		И я добавляю третью строку
			...
			Тогда открылось окно "Продажа товара (создание) *"
			И     в ТЧ "Товары" я активизирую поле "Количество"
			И     в ТЧ "Товары" в поле "Количество" я ввожу текст "7,000"
			И     в ТЧ "Товары" я активизирую поле "Цена"
			И     в ТЧ "Товары" в поле "Цена" я ввожу текст "85,00"
			И     я перехожу к следующему реквизиту
			И     В форме "Продажа товара (создание) *" в ТЧ "Товары" я завершаю редактирование строки
